    ...
    <div class="container flex flex-col items-center justify-center w-full">
        ...
        <div class="form-container shadow-lg">
                ...
                <script>
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            window.location.href = 'login.php'; // Change 'login.php' to the correct path if needed
                        }
                    });
                </script>
            ...
            <form class="w-full max-w-[650px]" method="POST" action="backend/be_registration.php">
                ...
                <div class="g-recaptcha mb-2" data-sitekey="6LdwZG4qAAAAAJ8RumcDEYDSQxQjFEQuAhMvZzxP"></div>
